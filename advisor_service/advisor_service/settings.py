"""
Django settings for advisor_service project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='advisor_db'),
...
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://localhost:8000,http://localhost:8100', cast=lambda v: [s.strip() for s in v.split(',')])
...
ML_CONFIG = {
    ...
    'behavior_model': 'behavior_classifier.h5',
